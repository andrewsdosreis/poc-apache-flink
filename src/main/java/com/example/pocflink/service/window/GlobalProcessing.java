...
public class GlobalProcessing {
    ...
    public void run(String[] args) throws Exception {
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped.keyBy(0)
                .window(GlobalWindows.create()).trigger(CountTrigger.of(5)).reduce(new Reduce1());

        reduced.writeAsText("./data/output/window/globalProcessing").setParallelism(1);
