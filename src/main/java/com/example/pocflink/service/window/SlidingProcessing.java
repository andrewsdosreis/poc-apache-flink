...
public class SlidingProcessing {
    ...
    public void run(String[] args) throws Exception {
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped.keyBy(0)
                .window(SlidingProcessingTimeWindows.of(Time.seconds(2), Time.seconds(1))).reduce(new Reduce1());

        reduced.writeAsText("./data/output/window/slidingProcessing").setParallelism(1);
