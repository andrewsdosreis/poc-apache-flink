...
public class TumblingEvent {
    ...
    public void run(String[] args) throws Exception {
        ...
        }).windowAll(TumblingEventTimeWindows.of(Time.seconds(5))).reduce(new ReduceFunction<Tuple2<Long, String>>() {
        ...
        sum.writeAsText("./data/output/window/tumblingEvent").setParallelism(1);
